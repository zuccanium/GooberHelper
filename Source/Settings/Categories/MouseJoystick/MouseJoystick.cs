...
using System;
using Celeste.Mod.GooberHelper.Settings.Categories.MouseJoystick.Toggles;
    ...
    public static class MouseJoystick {
        ...
        public class MouseJoystickDisplay : Entity {
            ...
            public override void Render() {
                ...
                var center = new Vector2(1920 - Size / 2 - Padding, 1080 - Size / 2 - Padding);

                Draw.Circle(center, MouseThreshold * Size / 2, Color.Lime, 5, 12);

                Draw.Circle(center, Size / 2, Color.Red, 10, 12);
                Draw.Circle(center + VirtualPosition * Size / 2, 2, Color.Blue, 10, 1);
            }
        }
